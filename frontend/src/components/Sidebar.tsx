...
import {
  ...
  FaFileAlt, FaShieldAlt, FaCogs, FaCalendarAlt, FaSignOutAlt, FaFolder,
  FaSitemap, FaKey
} from 'react-icons/fa';
  ...
  return (
    <div className="w-64 h-screen bg-green-900 text-white flex flex-col">
      ...
      <nav className="flex-1 px-2">
        ...
        <SidebarItem to="/Dashboard/Borrowers" Icon={FaUsers} label="Borrowers" />
        <SidebarItem to="/Dashboard/Loans" Icon={FaMoneyBill} label="Loans" />
        <SidebarItem to="/Dashboard/Repayments" Icon={FaUndo} label="Repayments" />
        <SidebarItem to="/Dashboard/LoanParameters" Icon={FaSlidersH} label="Loan Parameters" />
        <SidebarItem to="/Dashboard/Accounting" Icon={FaFileInvoiceDollar} label="Accounting" />
        <SidebarItem to="/Dashboard/Reports" Icon={FaFileAlt} label="Reports" />
        <SidebarItem to="/Dashboard/Collateral" Icon={FaFolder} label="Collateral" />
        <SidebarItem to="/Dashboard/AccessConfiguration" Icon={FaShieldAlt} label="Access Configuration" />
        ...
        <SidebarItem to="/Dashboard/Enclosures" Icon={FaFolder} label="Enclosures" />
        <SidebarItem to="/Dashboard/InvestorAccounts" Icon={FaUsers} label="Investor Accounts" />
        <SidebarItem to="/Dashboard/Calendar" Icon={FaCalendarAlt} label="Calendar" />
